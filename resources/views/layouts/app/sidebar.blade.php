        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                ...
                <flux:sidebar.group :heading="__('Admin')" class="grid">
                    ...
                    <flux:sidebar.item icon="key" :href="route('admin.tokens')" :current="request()->routeIs('admin.tokens')" wire:navigate>
                        {{ __('Tokens') }}
                    </flux:sidebar.item>
                    <flux:sidebar.item icon="receipt-percent" :href="route('admin.transactions')" :current="request()->routeIs('admin.transactions')" wire:navigate>
                        {{ __('Transactions') }}
                    </flux:sidebar.item>
